	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				ALAccount::addAccount($this->settings, '32289e514abe826fdfc151fe540e9406', '0f1f685bac5b8c764b82a5e6148c90ab');
		ALAccount::updateApiPublicKey($this->settings, '32289e514abe826fdfc151fe540e9406');
			}
